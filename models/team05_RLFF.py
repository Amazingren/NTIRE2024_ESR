...
class RLFN_mogai(nn.Module):
    ...
    def __init__(self,
                 ...
                 mid_channels=48,
                 upscale=4):
        super(RLFN_mogai, self).__init__()
        ...
        self.block_2 = FeedForward(mid_channels)
        # self.block_2 = RLFB(feature_channels, mid_channels)
        self.block_3 = RLFB(mid_channels, feature_channels)
        self.block_4 = FeedForward(feature_channels)
        self.block_5 = RLFB(mid_channels, feature_channels)
