...
class RLFB(nn.Module):
    ...
    def __init__(self,
                 ...
                 mid_channels=None,
                 out_channels=None,
                 esa_channels=16, conv1=False, conv2=False):
...
class ASR_Prune(nn.Module):
    """
    AdvancedSR (ASR), kernel pruning based on RLFB Network
    Model definition of AdvancedSR in NTIRE 2024 Efficient SR Challenge
    """
    ...
    def __init__(self,
        ...
        self.block_4 = RLFB(feature_channels, mid_channels, conv1=False, conv2=True)
        ...
        self.upsampler = pixelshuffle_block(feature_channels,
                                                  out_channels,
                                                  upscale_factor=upscale,kernel_size=1)
